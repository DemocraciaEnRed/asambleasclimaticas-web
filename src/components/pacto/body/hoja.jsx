    ...
    return <>
        <div className="hoja-de-ruta-wrapper">
            ...
            <div className="events">
                {events.events.map(event => <div key={event._id} className="columns event">
                    <div className="py-5 pl-5 column">
                        <div className="date is-flex is-relative is-justify-content-space-between">
                            <p className="pt-1">{formatDate(event.date, '-')}</p>
                            <div className="point"></div>
                        </div>
                    </div>
                    <div className=" column is-10">

                        <div className="py-5 pl-0 has-background-cream-light mb-3 w-75">
