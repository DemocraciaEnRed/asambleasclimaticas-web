                        ...
                        <div className="box-content">
                            <div className="mb-5">
                                <p className="mb-0 has-text-weight-bold">
                                    Gracias por participar en (re)surgentes.
                                </p>
                                <span className="has-text-weight-light is-italic is-size-7">
                                    * Obrigado por participar do (re)surgentes.
                                </span>
                            </div>
                            <div>
                                <p className="mb-0 ">
                                    Enviamos un e-mail a la casilla &quot;
                                    {email}&quot;, deberías recibirlo en los
                                    próximos minutos. No te olvides de revisar
                                    la carpeta de Spam si no lo recibes en unos
                                    minutos.
                                </p>
                                <span className="has-text-weight-light is-italic is-size-7">
                                    * Enviamos um e-mail para a caixa &quot;
                                    {email}&quot;; você deverá recebê-lo nos
                                    próximos minutos. Não se esqueça de
                                    verificar a pasta de Spam se não o receber
                                    em alguns minutos.
                                </span>
                            </div>
                        </div>
